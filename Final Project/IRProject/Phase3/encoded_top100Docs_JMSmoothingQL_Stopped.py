...
input_path = r'/Users/mihirg/Desktop/InformationRetrievalSpring2018/Final/IRProject/Phase1/Task3_Data_Stopped/Encoded-Stopped_QLM-Top100Docs-perQuery'
...
def write_to_file():
    output = open(output_path + 'Encoded-QueryID_Top100Docs_QLM_Stopped.txt', 'wb')
...
def encoder_documents():
    for file in os.listdir(input_path):
        ...
        query_number = f.split("Encoded-Top100Docs-Stopped_QLM_")
