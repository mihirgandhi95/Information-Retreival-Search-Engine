...
input_path = r'/Users/mihirg/Desktop/InformationRetrievalSpring2018/Final/IRProject/Phase1/Task1_JMSmoothedQL/encoded_JMSmoothing_top100_docs_perQuery'
...
def encoder_documents():
    for file in os.listdir(input_path):
        ...
        query_number = f.split("Encoded_Top100Docs-QLM_")
...
def write_to_file():
    output = open(output_path + 'Encoded-QueryID_Top100Docs_QLM.txt', 'wb')
