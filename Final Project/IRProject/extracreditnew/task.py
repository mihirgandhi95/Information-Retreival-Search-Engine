...
def enter_query():
    user_input = input("Hello do you want to enter the query term? yes/no \n")
...
def remove_stop_words_from_query(query):
    ...
    choose_to_remove_stopwords = input("hello do you want to remove the stop words from query? y/n \n ")
